...
public class UserInterface_GUI extends JFrame implements ActionListener
{
    ...
    public UserInterface_GUI(Controller_GUI rController)
    {
        ...
        // Set frame
        setTitle("Breakfast Story Management System");
    ...
    private void createMasterPanelConpornents()
    {
        ...
        headTitle = new JLabel("Breakfast Story Management System");
        headTitle.setIcon(new ImageIcon(UserInterface_GUI.class.getResource("/images/Logo1.jpg")));
        headTitle.setForeground(Color.WHITE);
        headTitle.setPreferredSize(new Dimension(500, 30));
        headTitle.setFont(new Font("Cochin", Font.BOLD | Font.ITALIC, 20));
        ...
        taMessage.setText("Wellcome!! in Breakfast Story");
    ...
    *****************************************************************/
    private class LoginPanel extends JPanel implements ActionListener
    {
        ...
        public LoginPanel()
        {
           ...
           /* label1 = new JLabel();
            label1.setText("Login as a Employee :");*/

            chbIsManager1 = new JCheckBox1("Login as Employee");
            gbc.gridx = 1;
            gbc.gridy = 4;
            gbc.gridwidth = 2;
            gbLayout.setConstraints(chbIsEmployee, gbc);
            this.add(chbIsEmployee);
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnLoginOK)
            {
                ...
                if( rcController.loginCheck(Integer.parseInt(inputID), inputPassword, isManager))
                {
                    ...
                    displayMessage("Wellcome to Breakfast Story, " + currentUserName);
                    tfUserID.setText("");
                    pwPassword.setText("");
                    changeMainPanel("Home");
                    setClockOutButton();
    ...
    *****************************************************************/       
    private class MenuListPanel extends JPanel implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            else if (ae.getSource() == btnSpecial)
            {
                showMenuList(MenuItem.SPECIAL);
		...
		public JButton getBtnBreakfast() {
			return btnBreakfast;
		}

		public void setBtnBreakfast(JButton btnBreakfast) {
			this.btnBreakfast = btnBreakfast;
		}
    }
    ...
    *****************************************************************/       
    private class EditMenuItemPanel extends JPanel implements ActionListener
    {
        ...
        public EditMenuItemPanel()
        {
            ...
            String[] combodata = {"breakfast", "Drink", "Special", "Dessert"};
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnOK)
            {
                ...
                if( strMenuType.equals("Breakfast"))
                {
                    menuType = MenuItem.BREAKFAST;
                }
                else if( strMenuType.equals("Drink"))
                {
                    menuType = MenuItem.DRINK;
                }
                else if( strMenuType.equals("Special"))
                {
                    menuType = MenuItem.SPECIAL;
                }
                else    //Dessert
                {
    ...
    *****************************************************************/       
    private class OrderDetailPanel extends JPanel implements ActionListener, ListSelectionListener
    {
        ...
        public OrderDetailPanel()
        {
            ...
            gbc.gridx = 3;
            gbc.gridy = 2;
            gbLayout.setConstraints(btnSpecial, gbc);
            menuListPanel.add(btnSpecial);
        ...
        public void actionPerformed(ActionEvent ae) {
             ...
             else if (ae.getSource() == btnSpecial)
            {
                ...
                menuList.setListData(rcController.createMenuList(MenuItem.SPECIAL).toArray());
                menuScrollPanel.getViewport().setView(menuList);
            }
             else if (ae.getSource() == btnDessert)
            {
